...
const minimalAssetResponse = {
    ...
    'results': [
      {
        ...
        'url':
          'http://kf.kobo.local/api/v2/assets/aBcDe12345/versions/veUGfHFYgnfkX9uxo3FoJ6/',
  ...
  'deployment__links': {
    ...
    'single_once_url':
      'http://ee.kobo.local/single/451523a0f57ad42817198c8b2ae93dc3',
  ...
  'downloads': [
    {
      'format': 'xls',
      'url': 'http://kf.kobo.local/api/v2/assets/aBcDe12345.xls',
    },
    {
      'format': 'xml',
      'url': 'http://kf.kobo.local/api/v2/assets/aBcDe12345.xml',
    },
  ],
  'embeds': [
    {
    ...
    {
      'format': 'xform',
      'url': 'http://kf.kobo.local/api/v2/assets/aBcDe12345/xform/',
    },
  ],
  ...
  'permissions': [
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/pVQvikEvyQYmQazbNxobN6/',
    ...
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/pFuSpuH2DYWCpqXL6vQ94x/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
    ...
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/p48wUoqUifRyj8bJssDKJi/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
      'permission':
        'http://kf.kobo.local/api/v2/permissions/change_submissions/',
      'label': 'Edit submissions',
    },
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/ptUCvQdK5ghnoHT5WHF8AA/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
      'permission':
        'http://kf.kobo.local/api/v2/permissions/delete_submissions/',
      'label': 'Delete submissions',
    },
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/pUKmhnLN2UXpxsipebgieS/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
    ...
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/poeQAKvMyjWsQYxejuPKpM/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
      'permission':
    ...
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/pBBjGJRLfMAqdtFvZeNj52/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
    ...
    {
      'url':
        'http://kf.kobo.local/api/v2/assets/aBcDe12345/permission-assignments/p4koRMKP65jdVQuacNPuke/',
      'user': 'http://kf.kobo.local/api/v2/users/zefir/',
