...
const Reports = React.lazy(
  () => import(/* webpackPrefetch: true */ "#/components/reports/reports")
);
const FormLanding = React.lazy(
  () =>
    import(/* webpackPrefetch: true */ "#/components/formLanding/formLanding")
);
const FormSummary = React.lazy(
  () =>
    import(/* webpackPrefetch: true */ "#/components/formSummary/formSummary")
);
const FormSubScreens = React.lazy(
  () => import(/* webpackPrefetch: true */ "#/components/formSubScreens")
);
const FormXform = React.lazy(
  () => import(/* webpackPrefetch: true */ "#/components/formXform")
);
const FormJson = React.lazy(
  () => import(/* webpackPrefetch: true */ "#/components/formJson")
);
const SectionNotFound = React.lazy(
  () => import(/* webpackPrefetch: true */ "#/components/sectionNotFound")
);
const FormNotFound = React.lazy(
  () => import(/* webpackPrefetch: true */ "#/components/formNotFound")
);
